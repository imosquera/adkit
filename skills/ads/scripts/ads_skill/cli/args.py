"""Shared customer-id resolution for the /ads:* entrypoints.

Before this, the brief->flag->env->yaml precedence and the dash-stripping
(111-111-1111 -> 1111111111) were re-implemented in create/audit/keyword_ideas/
...
def normalize_id(value: str | None) -> str | None:
    ...
    111-111-1111 -> 1111111111. None/empty passes through unchanged."""
