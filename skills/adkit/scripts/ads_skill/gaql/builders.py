...
The /adkit report builders historically lived in lib/report.py and are re-exported
...
# ===========================================================================
# /adkit report builders (moved here from lib.report; re-exported by lib.report)
# ===========================================================================
...
# ===========================================================================
# /adkit audit builders (bin/audit.py)
# ===========================================================================
...
def audit_search_terms_query(days: int, campaign_ids: list) -> str:
    ...
    /adkit report uses. Ids guarded digits-only."""
    ids = ",".join(gaql_id(c) for c in campaign_ids)
    return (
...
# ===========================================================================
# /adkit update builders (bin/apply_fixes.py)
# ===========================================================================
