...
**Temperature reference** (a spectrum, not a fixed four-bucket classification — judge
each theme's actual position, don't force it into one of these four labels):
