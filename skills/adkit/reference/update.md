---
description: "Apply deterministic updates from an /adkit audit to a live campaign via a validated plan: RSA/extension/negative/budget edits, positive-keyword editing, and campaign on/off (ads.sh update). Dry-run unless --apply."
