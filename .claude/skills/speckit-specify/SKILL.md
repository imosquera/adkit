...
description: 'Wraps /speckit-specify to keep the agent-os dashboard branch-status
argument-hint: "Describe the feature you want to specify"
  card current: mark the `specify` phase active on entry, done on completion. Composes
  with other specify wrappers via the wrap seam.'
